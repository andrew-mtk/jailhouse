...
static const eint_config_descr_t mt8390_eint_config_descr =
{
...
static int mt8390_eint_cell_init (struct cell*  cell)
{
    return (mtk_eint_cell_init (cell));
}

static void mt8390_eint_cell_exit (struct cell*  cell)
{
    mtk_eint_cell_exit (cell);
}

static unsigned int mt8390_eint_mmio_count_regions (struct cell*  cell)
{
    return (mtk_eint_mmio_count_regions (cell));
}

static int mt8390_eint_init (void)
{
    return (mtk_eint_init (&mt8390_eint_config_descr));
}

static void mt8390_eint_shutdown (void)
{
    mtk_eint_shutdown ();
}

DEFINE_UNIT (mt8390_eint, "mt8390_eint");
